...
/**
 * Useful utility methods from CTCI https://github.com/gaylemcd/CtCI-6th-Edition/
 * @author Brian
 *
 */
...
*/
	...
	public static TrieNode getTrieDictionary() {
		String[] wList = getListOfWords();
		TrieNode root = new TrieNode();
		for(int i = 0; i < wList.length; i++){
			TrieNode.insert(root, wList[i]);
		}
		return root;
	}
